<template>
  <div class="widget-preview">
    <div class="preview-container">
      <iframe :src="previewUrl +props.reviewUrl" width="100%" :height="height" frameborder="0" style="border:none;"></iframe>
      <div class="preview-divider"></div>
      <div class="preview-actions">
          <el-icon @click="copyCode" style="width: 1em; height: 1em; margin-right: 8px"><CopyDocument /></el-icon>
...
const basicCodeRepoUrl = 'https://raw.githubusercontent.com/aitguys/flutter_element/main/example/lib/pages/';
const previewUrl = 'http://localhost:59886/#/';
