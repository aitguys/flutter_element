  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: WidgetPreview(
        ...
        code: getCodeUrl('form', 'form_basic.dart'),
...
class FormBasicPreview extends StatefulWidget {
  const FormBasicPreview({super.key});

  @override
  State<FormBasicPreview> createState() => _FormBasicPreviewState();
}

class _FormBasicPreviewState extends State<FormBasicPreview> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
