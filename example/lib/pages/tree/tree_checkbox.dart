...
class TreeCheckboxPreview extends StatelessWidget {
  const TreeCheckboxPreview({super.key});

  @override
  Widget build(BuildContext context) {
    return WidgetPreview(
      widget: _viewerContent(),
      code: getCodeUrl('tree_page', 'tree_checkbox.dart'),
      title: '可选择',
    );
  }
}

class TreeCheckboxView extends StatelessWidget {
  const TreeCheckboxView({super.key});
