...
class TreeDraggablePreview extends StatelessWidget {
  const TreeDraggablePreview({super.key});

  @override
  Widget build(BuildContext context) {
    return WidgetPreview(
      widget: _viewerContent(),
      code: getCodeUrl('tree_page', 'tree_draggable.dart'),
      title: '可拖拽',
    );
  }
}

class TreeDraggableView extends StatelessWidget {
  const TreeDraggableView({super.key});
