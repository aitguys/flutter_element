          ...
          children: [
            ...
            EDescriptions(
              ...
              items: [
                ...
                EDescriptionItem(
                    label: '手机号', content: const Text('12345678901')),
            ...
            EDescriptions(
              ...
              items: [
                EDescriptionItem(
                    label: '订单号', content: const Text('20240601001')),
                EDescriptionItem(
                    label: '下单时间', content: const Text('2024-06-01')),
            ...
            EDescriptions(
              ...
              items: [
                EDescriptionItem(
                    label: '商品名', content: const Text('iPhone 15')),
